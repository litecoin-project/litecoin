...
public:
    CMainParams() {
        ...
        consensus.script_flag_exceptions.emplace( // P2SH-wrapped witness sweep before segwit activation
            uint256S("0x5cb3178ac34fd1db2c4bb3edf6341319cce91782948e5125f097dd24ba5e7e78"), SCRIPT_VERIFY_P2SH);
...
public:
    explicit SigNetParams(const ArgsManager& args)
    {
        ...
        genesis = CreateGenesisBlock(1598918400, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5557c281d5f0f394bd38c9c4c6bd641d2920ffae34a3c7713da43eb2ce80a4aa"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
