...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " penguincoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  penguincoin-tx [options] <hex-tx> [commands]  Update hex-encoded penguincoin transaction\n" +
            "or:     penguincoin-tx [options] -create [commands]   Create hex-encoded penguincoin transaction\n" +
            "\n";
