...
BOOST_AUTO_TEST_CASE(patharg)
{
    ...
    SetupArgs({dir});
    ResetArgs("");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir"), fs::path{});

    const fs::path root_path{"/"};
    ResetArgs("-dir=/");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir"), root_path);
    ...
    ResetArgs("-dir=C:\\");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir"), win_root_path);
    ...
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir"), absolute_path);
    ...
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir"), relative_path);
    ...
    ResetArgs("");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir", "default"), fs::path{"default"});

    ResetArgs("-dir=override");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir", "default"), fs::path{"override"});
    ...
    ResetArgs("-nodir");
    BOOST_CHECK_EQUAL(m_args.GetPathArg("-dir", "default"), fs::path{});
}
