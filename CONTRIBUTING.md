Contributing to PenguinCoin Core
============================

The PenguinCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the PenguinCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/penguincoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to penguincoin-qt
...
The following applies to code changes to the PenguinCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall PenguinCoin
Network Protocol consensus changes.

Whether a pull request is merged into PenguinCoin Core rests with the project merge
...
Patches that change PenguinCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PenguinCoin consensus, it must have been
...
The project leader is the release manager for each PenguinCoin Core release.
