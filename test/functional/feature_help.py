...
"""Verify that starting penguincoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start penguincoin with -h for help text")
        ...
        self.log.info("Start penguincoin with -version for version information")
        ...
        self.log.info("Start penguincoind with -fakearg to make sure it does not start")
