# Support for Output Descriptors in PenguinCoin Core

Since PenguinCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `pgc1...` for mainnet or `tpgc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing PenguinCoin Core wallets, a convenience function `combo` is
